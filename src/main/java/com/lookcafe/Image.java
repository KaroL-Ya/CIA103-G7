...
public class Image {
    public static void main(String[] args) {
        ...
        // 圖片檔案夾路徑
        String imageFolderPath = "src/main/resources/templates/front-end/lookcafe/cafeimg/"; // 這裡指定資料夾路徑
        ...
        try (Connection connection = DriverManager.getConnection(URL, User, Password)) {
            ...
            // 準備 SQL 語句，將圖片儲存到 `` 表格中的 `` 欄位
            String sql = "UPDATE cafe SET IMG=? Where CAFE_ID=?";
